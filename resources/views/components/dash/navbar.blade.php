        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ asset('backend') }}/index.html">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img src="{{ asset('backend') }}/assets/img/icons/image.png"
        ...
        <div class="search-box navbar-top-search-box d-none d-lg-block" data-list='{"valueNames":["title"]}'
            ...
            <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                <input class="form-control search-input fuzzy-search rounded-pill form-control-sm" type="search"
                    placeholder="Search{{ asset('backend') }}." aria-label="Search" />
            ...
            <div class="dropdown-menu border start-0 py-0 overflow-hidden w-100">
                <div class="scrollbar-overlay" style="max-height: 30rem;">
                    ...
                    <a class="dropdown-item" href="{{ asset('backend') }}/apps/e-commerce/landing/product-details.html">
                        <div class="d-flex align-items-center">

                            <div class="fw-normal text-body-highlight title"> <span
                                    class="fa-solid fa-clock-rotate-left" data-fa-transform="shrink-2"></span> MacBook
                                Air - 13″</div>
                        </div>
                    </a>
                ...
                <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                        ...
                        <div class="file-thumbnail me-2"><img class="h-100 w-100 object-fit-cover rounded-3"
                                src="{{ asset('backend') }}/assets/img/products/60x60/3.png" alt="" /></div>
                        <div class="flex-1">
                ...
                <div class="py-2"><a class="dropdown-item"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fw-normal text-body-highlight title"><span
                                    class="fa-solid fa-file-zipper text-body" data-fa-transform="shrink-2"></span>
                    ...
                    <a class="dropdown-item"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fw-normal text-body-highlight title"> <span
                                    class="fa-solid fa-file-lines text-body" data-fa-transform="shrink-2"></span>
                ...
                <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                        ...
                        <div class="avatar avatar-l status-online  me-2 text-body">
                            <img class="rounded-circle " src="{{ asset('backend') }}/assets/img/team/40x40/10.webp"
                                alt="" />
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center"
                        ...
                        <div class="avatar avatar-l  me-2 text-body">
                            <img class="rounded-circle " src="{{ asset('backend') }}/assets/img/team/40x40/12.webp"
                                alt="" />
                ...
                <div class="card position-relative border-0">
                    ...
                    <div class="card-footer p-0 border-top border-translucent border-0">
                        <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                class="fw-bolder" href="{{ asset('backend') }}/pages/notifications.html">Notification
                                history</a></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                        <div class="row text-center align-items-center gx-0 gy-0">
                            <div class="col-4"><a
                                    ...
                                    href="#!"><img
                                        src="{{ asset('backend') }}/assets/img/nav-icons/behance.webp" alt=""
                                        width="30" />
                            ...
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img src="{{ asset('backend') }}/assets/img/nav-icons/slack.webp"
                                        alt="" width="30" />
                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Slack</p>
                                </a></div>
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img src="{{ asset('backend') }}/assets/img/nav-icons/gitlab.webp"
                                        alt="" width="30" />
                            ...
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img src="{{ asset('backend') }}/assets/img/nav-icons/trello.webp"
                                        alt="" width="30" />
                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Trello</p>
                                </a></div>
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img src="{{ asset('backend') }}/assets/img/nav-icons/figma.webp"
                                        alt="" width="20" />
                            ...
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img
                                        src="{{ asset('backend') }}/assets/img/nav-icons/twitter.webp" alt=""
                                        width="30" />
                            ...
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img
                                        src="{{ asset('backend') }}/assets/img/nav-icons/spotify.webp" alt=""
                                        width="30" />
